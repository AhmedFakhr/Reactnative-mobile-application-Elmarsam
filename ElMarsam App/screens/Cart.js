...
import { Image, StyleSheet, ScrollView, TextInput,View, TouchableOpacity, ActivityIndicator, Alert } from "react-native";
				...
				{!cartItemsIsLoading &&
                    ...
                    onChangeText={(searchKeyword) => {
						...
						<View style={{flexDirection: 'row', justifyContent: 'flex-end', height: 32, paddingRight: 20, alignItems: 'center'}}>
							<TouchableOpacity style={[styles.centerElement, {backgroundColor: '#0faf9a', width: 100, height: 25, borderRadius: 5}]} onPress={() =>   navigation.navigate("Checkout") }>
